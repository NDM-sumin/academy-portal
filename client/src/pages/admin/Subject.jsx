  ...
  const formItems = [
    ...
    <Form.Item
      ...
      rules={[
        {
          required: true,
          message: "Vui lòng chọn các chuyên ngành học môn học này",
        },
      ]}
    >
      <Select
    ...
    <Form.Item
      ...
      label="Phí đăng ký"
      name="price"
      rules={[{ required: true, message: "Vui lòng nhập học phí của môn học" }]}
    >
      <InputNumber
        prefix="VNĐ"
        style={{ width: "100%" }}
        min={0}
        placeholder="Học phí của môn học"
      />
    </Form.Item>,
  ];
  const form = {
